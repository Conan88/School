...
//egen redigert versjon
    ...
    class OrientedBoundingBox2 // Used in the BoundingBoxTest
    {
    public:
        OrientedBoundingBox2 (const sf::RectangleShape& Object) // Calculate the four points of the OBB from a transformed (scaled, rotated...) sprite
        {
            sf::Transform trans = Object.getTransform();
            sf::IntRect local = Object.getTextureRect();
            Points[0] = trans.transformPoint(0.f, 0.f);
    ...
    bool BoundingBoxTest(const sf::Sprite& Object1, const sf::RectangleShape& Object2)
    {
        OrientedBoundingBox OBB1 (Object1);
        OrientedBoundingBox2 OBB2 (Object2);
